...
function Product() {
  ...
  const imageBodyTemplate = (rowData) => {
    ...
    return <img src={`${image.imagePath}`} onError={(e) => e.target.src='https://www.primefaces.org/wp-content/uploads/2020/05/placeholder.png'} alt={image.name} className="product-image" />;
  }
    ...
    <div className="datatable-crud-demo">
      ...
      <Dialog visible={productDialog} style={{ width: '450px' }} header="Product Details" modal className="p-fluid" footer={productDialogFooter} onHide={hideDialog}>
                <div className="field">
                    ...
                    {image.imagePath && <img src={`${image.imagePath}`} onError={(e) => e.target.src='https://www.primefaces.org/wp-content/uploads/2020/05/placeholder.png'} alt={image.name} className="product-image block m-auto pb-3" />}
                </div>
