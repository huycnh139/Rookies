...
import {addCategoryRequest, deleteCategoryRequest, getCategoryRequest} from '../../api/services/categoryServices'
...
function CategoryManagement() {
  ...
  const createdBodyTemplate = (category) => {
    return formatDate(category.dateCreate);
  } 

  const updatedBodyTemplate = (rowData) => {
    return (
      <React.Fragment>
          <Button icon="pi pi-pencil" className="p-button-rounded p-button-warning" onClick={() => confirmUpdateCategory(rowData)} />
      </React.Fragment>
  );
  } 
    ...
    <div className="datatable-crud-demo">
        ...
        <div className="card">
          ...
          <DataTable globalFilter={globalFilter} value={categories} header={header} responsiveLayout="scroll">
            ...
            <Column header="Updated" body={updatedBodyTemplate} exportable={false} style={{ minWidth: '8rem' }}></Column>
